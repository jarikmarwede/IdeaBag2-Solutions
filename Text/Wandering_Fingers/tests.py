...
from Text.Wandering_Fingers.wandering_fingers import \
    find_possible_words, get_dictionary, get_possible_words

DICTIONARY_FILE = pathlib.Path(__file__).parent.absolute().__str__() + "/enable1.txt"
