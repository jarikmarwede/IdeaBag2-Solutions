...
from Numbers.Binary_to_Decimal_and_Back_Converter.binary_to_decimal_and_back_converter import \
    binary_to_decimal, decimal_to_binary, decimal_to_hexadecimal, decimal_to_octal
